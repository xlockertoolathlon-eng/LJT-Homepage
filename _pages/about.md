...
* **On the Perception Bottleneck of VLMs for Chart Understanding** (First author). *arXiv*, 2025.
  Junteng Liu, Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He. GitHub code: Vision4Chart.
* **On the Universal Truthfulness Hyperplane Inside LLMs** (First author). *EMNLP 2024*, 2024.
  Junteng Liu, Shiqi Chen, Yu Cheng, Junxian He. GitHub code: Universal_Truthfulness_Hyperplane.
